...
public class BillBulkImportRequestDTO {
    ...
    @Valid
    private List<BillImportItemDTO> items;

    @NotNull(message = "Estratégia de duplicatas é obrigatória")
    private DuplicateStrategy duplicateStrategy;

    public BillBulkImportRequestDTO() {
    }

    public BillBulkImportRequestDTO(List<BillImportItemDTO> items, DuplicateStrategy duplicateStrategy) {
        this.items = items;
        this.duplicateStrategy = duplicateStrategy;
    }

    // Getters and Setters
    public List<BillImportItemDTO> getItems() {
        return items;
    }

    public void setItems(List<BillImportItemDTO> items) {
        this.items = items;
    }
